    ...
    >
      <div class="carousel-inner text-center">
		...
		<div class="carousel-item active" data-bs-interval="5000">
          <img src="Images/two.jpg" class="d-block mx-auto" />
        </div>
	...
	<?php foreach($assetsCards as $assetCard)	{ ?>
      ...
      <div class="col">
        <div class="card homeCard">
          <img class="card-img-top img-fluid" src=<?php echo '"'.$assetCard->getImageLink().'"'; ?> />
          <div class="card-body" style="text-align: center;">
            <h5 class="card-title"><?php echo '"'.$assetCard->getTitle().'"'; ?></h5>
            <p class="card-text"><?php echo '"'.$assetCard->getText1().'"'; ?></p>
			<a href=<?php echo '"'.$assetCard->getText2().'"'; ?> class="btn btn-primary stretched-link">Visit</a>
          </div>
        </div>
      </div>
	<?php } ?>
